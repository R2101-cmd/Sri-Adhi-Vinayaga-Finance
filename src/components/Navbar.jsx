    ...
    <header className="glass-nav sticky top-0 z-50">
      <nav className="container-max flex min-h-20 items-center justify-between px-5 sm:px-8 lg:px-12">
        <NavLink to="/" className="flex items-center gap-3" onClick={() => setOpen(false)}>
          <span className="grid h-11 w-11 place-items-center rounded-md bg-emeraldDeep font-display text-xl font-black text-gold">
            SA
          </span>
          <span className="max-w-[210px] text-sm font-black uppercase leading-5 tracking-[0.1em] text-emeraldDeep sm:max-w-none">
            {business.shortName}
          </span>
        </NavLink>
